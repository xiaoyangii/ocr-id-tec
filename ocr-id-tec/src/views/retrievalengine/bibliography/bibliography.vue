    ...
    return {
      ...
      copyList: [
        ...
        },
        {
          ...
          author: "作者： " + "葛群",
          details: "麻黄首见于《神农本草经》,其昧辛、苦,性温,归膀胱经、肺经,具有发汗解表、宣肺 平喘、利水消肿等功效.现代医学研究认为,麻黄具有广泛的药理作用,如利尿、发汗、免疫抑制、抗凝血等.本研究分析中医古籍中对于麻黄治疗肾脏病的记载,并结合现代医学研究结果,从麻黄的药用价值与药理作用、治疗功效、存在...",
          date: "2020",
          name: "刊名： " + "实用临床医药杂志"
        },
        {
          ...
          details: "现药对的研究多基于传统中医药理论,借助现代技术手段从体外化学成分、药理效应、药代动力学和代谢组学等角度剖析临床用药经验。本课题为麻黄类药对组成规律基础研究 (国家自然科学基金重点项目)的部分内容,研究对象麻黄-石膏,性味相反,一温一寒、一升一降、一宣一清、虽相反而实相成,达仲景方中11首...",
          date: "2021",
          name: "刊名： " + "于海峰"
        },
        {
